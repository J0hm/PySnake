...
class food():
    def __init__(self):
        self.x = rand.randrange(1, cellCount)
        self.y = rand.randrange(1, cellCount) 
        self.id = app.g.create_rectangle(((self.x-1)*cellSize), ((self.y-1)*cellSize), (self.x*cellSize), (self.y*cellSize), fill="red")
